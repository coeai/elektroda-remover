(function() {
    var ElektrodaRemover = {
        currentUrl: {}, 
        constants: {
            queries: {
                result_links: 'div.g:not([style*="display:none"]):not([style*="display: none"]) .r > a[href*="https://poszukaj.elektroda.pl"]', 
            ...
            console: {
                needs_to_be_updated: 'ElektrodaRemover selectors need to be updated!', 
                removed: 'Elektroda links were removed from this search.'
            }, 
